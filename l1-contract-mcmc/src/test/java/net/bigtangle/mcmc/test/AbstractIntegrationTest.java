...
import net.bigtangle.l1.contract.ContractL1MCMCStart;
...
@SpringBootTest(classes = ContractL1MCMCStart.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
...
public abstract class AbstractIntegrationTest {
	...
	protected Transaction createTestTransaction() throws Exception {
		...
		SignatureBundle tsrecsig = genesiskey.sign(sighash);
		Script inputScript = ScriptBuilder.createInputScriptForPQ(tsrecsig);
		input.setScriptSig(inputScript);
		return tx;
	}
