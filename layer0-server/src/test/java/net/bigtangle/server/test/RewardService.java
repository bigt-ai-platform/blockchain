...
/**
 * <p>
 * Test helper: builds the BEACON (reward) chain the PoS way. The production
 * beacon is proposed by {@code SlotService.proposeBeaconBlock}; this in-process
 * helper constructs the equivalent RewardInfo block so integration tests can
 * confirm transactions without running a slot/validator.
 * </p>
 */
@Service
