...
public class Script {
    ...
    private void parse(byte[] program) throws ScriptException {
        ...
        while (bis.available() > 0) {
            ...
            if (opcode >= 0 && opcode < OP_PUSHDATA1) {
                ...
                dataToRead = bis.read() | ((long)bis.read() << 8);
     ...
     *
     * @deprecated Use {@link #executeScript(net.bigtangle.core.Transaction, long, net.bigtangle.script.Script, java.util.LinkedList, java.util.Set)}
     * instead.
     */
    @Deprecated
