...
import static net.bigtangle.core.Utils.*;
...
public class PartialMerkleTree extends Message {
 ...
 public  void setPartialMerkleTree(NetworkParameters params, byte[] payloadBytes,   int offset ) throws ProtocolException {
    ...
    public Sha256Hash getTxnHashAndMerkleRoot(List<Sha256Hash> matchedHashesOut) throws VerificationException {
        ...
        if (transactionCount > NetworkParameters.MAX_DEFAULT_BLOCK_SIZE / 60) // 60 is the lower bound for the size of a serialized CTransaction
