...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link net.bigtangle.crypto.MnemonicCode} for more
     ...
     *
     * @throws net.bigtangle.crypto.MnemonicException if check fails
     */
