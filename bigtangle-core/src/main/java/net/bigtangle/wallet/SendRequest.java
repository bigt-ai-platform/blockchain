...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link net.bigtangle.wallet.Wallet#getBalance()} - the fees required
     ...
     */
    public Coin feePerKb = Coin.valueOf(0, NetworkParameters.BIGTANGLE_TOKENID);
