...
public abstract class DatabaseFullBlockStore extends DatabaseFullBlockStoreBase implements FullBlockStore {
	...
	public List<MultiSign> getMultiSignListByTokenidAndAddress(final String tokenid, String address)
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_MULTISIGN_TOKENID_ADDRESS_SQL)) {
            preparedStatement.setString(1, tokenid);
	...
	public Sha256Hash getRewardPrevBlockHash(Sha256Hash blockHash) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_TX_REWARD_PREVBLOCKHASH_SQL)) {
            preparedStatement.setBytes(1, blockHash.getBytes());
            ResultSet resultSet = preparedStatement.executeQuery();
            resultSet.next();
	...
	public TXReward getRewardConfirmedAtHeight(long chainlength) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_TX_REWARD_CONFIRMED_AT_HEIGHT_REWARD_SQL)) {
	...
	public TXReward getMaxConfirmedReward() throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_TX_REWARD_MAX_CONFIRMED_REWARD_SQL)) {
            ResultSet resultSet = preparedStatement.executeQuery();
            if (resultSet.next()) {
	...
	public List<TXReward> getAllConfirmedReward() throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_TX_REWARD_ALL_CONFIRMED_REWARD_SQL)) {
            ResultSet resultSet = preparedStatement.executeQuery();
	...
	public void updateSubtanglePermission(String pubkey, String userdataPubkey, String status)
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(UPATE_ALL_SUBTANGLE_PERMISSION_SQL)) {
	...
	public List<Map<String, String>> getAllSubtanglePermissionList() throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_ALL_SUBTANGLE_PERMISSION_SQL)) {
	...
	public void updateContractEventCancelSpent(Set<Sha256Hash> cancels, Sha256Hash blockhash, Boolean spent)
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(CONTRACTEVENTCANCEL_UPDATE_SPENT_SQL)) {
	...
	public void updateOrderBlockhash(Sha256Hash blockhash, Sha256Hash collectinghash, boolean confirm, boolean spent,
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(getUpdate()
                + " orders SET spent = ?, spenderblockhash = ?, confirmed =? " + " WHERE collectinghash=? and blockhash=? ")) {
	...
	public void updateContractEventBlockhash(Sha256Hash blockhash, Sha256Hash collectinghash, boolean confirm, boolean spent,
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(getUpdate()
                + " contractevent SET spent = ?, spenderblockhash = ?, confirmed =? " + " WHERE collectinghash=? and blockhash=? ")) {
	...
	public void updateContractResultConfirmed(Sha256Hash record, boolean confirm) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(UPDATE_CONTRACTRESULT_CONFIRMED_SQL)) {
	...
	public List<Contractresult> getContractresultWithPrev(Sha256Hash prev) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_CONTRACTRESULT_PREV_HASH_SQL)) {
	...
	public void prunedBlocks(Long height, Long chain) throws BlockStoreException {
        ...
        try (PreparedStatement deleteStatement = getConnection().prepareStatement(" delete FROM blocks WHERE" + "   hash  = ? ")) {
	...
	public void prunedHistoryUTXO(Long maxRewardblock) throws BlockStoreException {
        ...
        try (PreparedStatement deleteStatement = getConnection().prepareStatement(" delete FROM outputs WHERE  spent=1 AND "
	...
	public boolean existBlock(Sha256Hash hash) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(" select hash from blocks where hash = ?")) {
            preparedStatement.setBytes(1, hash.getBytes());
            ResultSet resultSet = preparedStatement.executeQuery();
	...
	public boolean existMyserverblocks(Sha256Hash prevhash) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(" select hash from myserverblocks where prevhash = ?")) {
            preparedStatement.setBytes(1, prevhash.getBytes());
            ResultSet resultSet = preparedStatement.executeQuery();
            return resultSet.next();
        } catch (SQLException ex) {
	...
	public List<Sha256Hash> getWhereConfirmedNotMilestone() throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_BLOCKS_CONFIRMED_AND_NOT_MILESTONE_SQL)) {
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
	...
	public void deleteChainBlockQueue(List<ChainBlockQueue> chainBlockQueues) throws BlockStoreException {
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(" delete from chainblockqueue  where hash = ?")) {
	...
	public void deleteLockobject(String lockobjectid) throws BlockStoreException {
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(" delete from lockobject  where lockobjectid = ?")) {
	...
	public Contractresult getMaxMilestoneContractresult(String contracttokenid) throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_CONTRACTRESULT_MAX_MILESTONE_SQL)) {
	...
	public List<Contractresult> getConfirmedContractresultNotMilestone(String contracttokenid)
        ...
        List<Contractresult> re = new ArrayList<>();
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_CONTRACTRESULT_CONFIRMED_NOTMILESTONE_SQL)) {
            preparedStatement.setString(1, contracttokenid);
            ResultSet resultSet = preparedStatement.executeQuery();
	...
	public Orderresult getMaxMilestoneOrderresult() throws BlockStoreException {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_ORDER_RESULT_MAX_MILESTONE_SQL)) {
            ResultSet resultSet = preparedStatement.executeQuery();
            if (resultSet.next()) {
	...
	public List<Orderresult> getConfirmedOrderresultNotMilestone() throws BlockStoreException {
        ...
        List<Orderresult> re = new ArrayList<>();
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(SELECT_ORDERRESULT_CONFIRMED_NOTMILESTONE_SQL)) {
