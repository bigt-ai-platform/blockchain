...
import net.bigtangle.l1.ordermatch.OrderMatchL1MCMCStart;
...
@SpringBootTest(classes = OrderMatchL1MCMCStart.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
...
public abstract class AbstractIntegrationTest {
	...
	protected Block makeTestToken(PQKey testKey, BigInteger amount, List<Block> addedBlocks, int decimal)
		...
		// Sign with domain signer (genesis key) to satisfy checkDomainPermission
		pullBlockDoMultiSign(tokens.getTokenid(), wallet.walletKeys().get(0), null);
